          ...
          <div className="jumbotron jumbotron-fluid py-5">
            <div className="container text-center py-5">
              ...
              <p>
                ...
                you have to many of screen time your eyes will hurt so much so
                we limited anyone that goes on the website 1 hour because we
                don't want any damaging eyes thanks to us and we just want
                people to get crafty and also to do homework.
              </p>
            </div>
          </div>
        </section>
